...
* The Add On is meant to mmake creating complex and helpful trading      *
...
Shiny Star Sprite
    ...
    This function autofills selected cells with a sprite of the in game red star denoting a Pokemon as shiny. Particularly useful to reference the second argument of the Pokemon Sprites function.
...
Hatch Thread Link
    ...
    This function autofills the selected cells with the basic Hyperlink syntax to link a hatch thread from /r/SVExchange.
